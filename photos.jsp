...
window.onresize = function remapResize() {
   ...
   function fullScreen(el) {
	   if(el.width>el.height){
		   document.getElementById("fullScreenImg").style.width = '60%';
		   document.getElementById("fullScreenImg").style.left = '20%';
	   } else {
		   document.getElementById("fullScreenImg").style.width = '30%';
		   document.getElementById("fullScreenImg").style.left = '35%';
	   }
	   document.getElementById("actualImage").src = el.src;
...
<body onload="remap();">
<div id="fullScreenImg" style="top:4%;visibility:hidden;z-index:5000;position:fixed;">
<img id="actualImage" src="" style="width:100%;" />
<img id="closeFullscreenButton" src="images/close.png" style="cursor:pointer;visibility:hidden;position:absolute;left:-40px;top:0px;z-index:5000;" onclick="closeFullscreen();"/>
</div>
<div id="overlay" style="z-index:4000;
...
<div name="main" id="main" style="position:absolute;width:80%;left:10%;top:2%;font-family:Arial;font-size:14px;" >
<img name="title" id="title"  style="left:40%;width:20%;position:absolute;" src="photos.png" alt="Cannot display image" border=0/><br/><br/>
<br/>
<hr style="left:5%;width:90%;color:#800517;background-color:#800517;height:2px;"></hr>
<div name="photos" id="photos" align="center" style="position:relative;left:5%;width:90%;height:100%;overflow:scroll;overflow-x:hidden;">


<table style="top:5%;position:absolute;width:100%;">
<tr>
<td align="center" style="width:30%;" >
<img src="albums/album1/K&C1.jpg" style="width:90%;padding:5px;" onclick="javascript:fullScreen(this);" />
</td>
<td align="center" style="width:30%;">
<img src="albums/album1/K&C2.jpg" style="width:90%;padding:5px;" onclick="javascript:fullScreen(this);" />
</td>
<td align="center" style="width:30%;">
<img src="albums/album1/K&C3.jpg" style="width:90%;padding:5px;" onclick="javascript:fullScreen(this);" />
</td>
</tr>
<tr>
<td align="center" style="width:30%;">
<img src="albums/album1/K&C13.jpg" style="width:90%;padding:5px;" onclick="javascript:fullScreen(this);" />
</td>
<td align="center" style="width:30%;">
<img src="albums/album1/K&C5.jpg" style="width:90%;padding:5px;" onclick="javascript:fullScreen(this);" />
</td>
<td align="center" style="width:30%;">
<img src="albums/album1/K&C14.jpg" style="width:90%;padding:5px;" onclick="javascript:fullScreen(this);" />
</td>
</tr>
<tr>
<td align="center" style="width:30%;">
<img src="albums/album1/K&C7.jpg" style="width:90%;padding:5px;" onclick="javascript:fullScreen(this);" />
</td>
<td align="center" style="width:30%;">
<img src="albums/album1/K&C8.jpg" style="width:90%;padding:5px;" onclick="javascript:fullScreen(this);" />
</td>
<td align="center" style="width:30%;">
<img src="albums/album1/K&C12.jpg" style="width:90%;padding:5px;" onclick="javascript:fullScreen(this);" />
</td>
</tr>
<tr>
<td align="center" style="width:30%;">
<img src="albums/album1/K&C10.jpg" style="width:90%;padding:5px;" onclick="javascript:fullScreen(this);" />
</td>
<td align="center" style="width:30%;">
<img src="albums/album1/K&C11.jpg" style="width:90%;padding:5px;" onclick="javascript:fullScreen(this);" />
</td>
<td align="center" style="width:30%;">
<img src="albums/album1/K&C9.jpg" style="width:90%;padding:5px;" onclick="javascript:fullScreen(this);" />
</td>
</tr>
<tr>
<td align="center" style="width:30%;">
<img src="albums/album1/K&C4.jpg" style="width:90%;padding:5px;" onclick="javascript:fullScreen(this);" />
</td>
<td align="center" style="width:30%;">
<img src="albums/album1/K&C6.jpg" style="width:90%;padding:5px;" onclick="javascript:fullScreen(this);" />
</td>
</tr>
</table>
...
if (document.getElementById('main')){
	function resizeVideo() {
		document.getElementById('main').style.width = (document.getElementById('mainImage').width * .80) + 'px';
		document.getElementById('main').style.height = ((document.getElementById('mainImage').width * .80) * (1/1.5)) + 'px';
	}
	resizeVideo();
